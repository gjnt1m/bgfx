...
#	define BGFX_CONFIG_DEBUG 0
 ...
 && !defined(BGFX_CONFIG_RENDERER_GXM)		  \
...
#	ifndef BGFX_CONFIG_RENDERER_GXM
#		define BGFX_CONFIG_RENDERER_GXM (0 \
					|| BX_PLATFORM_VITA     \
					? 1 : 0)
#	endif // BGFX_CONFIG_RENDERER_GNM
#else
...
#	define BGFX_CONFIG_MULTITHREADED ( (0 == BX_PLATFORM_EMSCRIPTEN && BX_CONFIG_SUPPORTS_THREADING == 1) ? 1 : 0)
